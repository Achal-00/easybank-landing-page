export default function Footer() {
  return (
    <section className="bg-dark-blue text-center py-[10%] grid gap-[1em] landscape:grid-cols-[0.3fr_0.2fr_0.2fr_0.5fr] landscape:py-[5%] landscape:px-[10%] landscape:text-left">
      <div className="grid justify-items-center gap-[2em] pb-[10%] landscape:justify-items-start landscape:pb-[0%]">
        <div>
          <svg
      ...
      <div className="grid gap-[1em] text-light-greyish-blue landscape:gap-[1em]">
        <p className="hover:cursor-pointer hover:text-lime-green">About Us</p>
        <p className="hover:cursor-pointer hover:text-lime-green">Contact</p>
        <p className="hover:cursor-pointer hover:text-lime-green">Blog</p>
      </div>
      <div className="grid gap-[1em] text-light-greyish-blue landscape:gap-[1em]">
        <p className="hover:cursor-pointer hover:text-lime-green">Careers</p>
        <p className="hover:cursor-pointer hover:text-lime-green">Support</p>
        <p className="hover:cursor-pointer hover:text-lime-green">
          Privacy Policy
        </p>
      </div>
      <div className="pt-[10%] grid gap-[2em] landscape:pt-0 landscape:justify-items-end">
